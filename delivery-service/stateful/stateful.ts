...
export class DeliveryServiceStatefulStack extends cdk.Stack {
  ...
  constructor(
    ...
    // allowing it to consume messages from the central bus i.e. single bus, multi-account pattern
    ...
    // i.e. we want consumer accounts to create their own rules, not having to add them in the central account iac
